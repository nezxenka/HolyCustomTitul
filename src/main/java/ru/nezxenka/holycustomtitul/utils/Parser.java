...
public class Parser {
    ...
    public static void sendClickableMessage(Player player, List<String> lines, String url, HolyCustomTitul plugin) {
        for (String line : lines) {
            String hover = plugin.getConfig().getString("messages.hover", "");
            hover = color(hover);
    ...
    public static String stripColor(String text) {
        ...
        String result = text;
        if (SUPPORTS_RGB) {
            result = HEX_PATTERN.matcher(text).replaceAll("");
        }
    ...
    private static void applyFormatting(TextComponent component,
